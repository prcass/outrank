...
function showNotification(message, type) {
    try {
        ...
        if (!message || typeof message !== 'string') {
            console.error('showNotification: Invalid message parameter');
            return;
        }
        ...
        if (!document.body) {
            console.error('showNotification: document.body not available');
            return;
        }
        ...
        setTimeout(function() {
            try {
                ...
                console.error('Error animating notification:', animError);
            }
        }, 10);
        ...
        setTimeout(function() {
            try {
                ...
                console.error('Error fading notification:', fadeError);
            }
        }, 3000);
...
function addConsoleMessage(message, type) {
    try {
        ...
        try {
            ...
            console.error('Error scrolling console:', scrollError);
        }
        ...
        try {
            ...
            console.error('Error cleaning up console messages:', cleanupError);
        }
